...
class Sculpture extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Sculpture', style: TextStyle(color: Colors.black)),
      ),
      body: FutureBuilder(
        future: _getUserUid(), 
  ...
  Widget _buildProductList(String userUid) {
    return StreamBuilder(
      stream: FirebaseFirestore.instance.collection('sculptureProduct').orderBy('productName').snapshots(),
    ...
    return ListTile(
      title: Text(
        ...
        style: TextStyle(
          ...
          color: Colors.white, // Burada yazı rengini beyaz olarak ayarladım.
        ),
      ),
      subtitle: Column(
                      ...
                      builder: (context) => AlertDialog(
                        ...
                        actions: [
                          TextButton(
                            ...
                            child: Text('Cancel', style: TextStyle(color: Colors.white)), // Burada yazı rengini beyaz olarak ayarladım.
                          ),
                          TextButton(
                            onPressed: () {
                            ...
                            child: Text('OK', style: TextStyle(color: Colors.white)), // Burada yazı rengini beyaz olarak ayarladım.
                          ),
                        ],
                      ),
                    );
  ...
  void _addNewProduct(BuildContext context) async {
    ...
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text('Add New Product', style: TextStyle(color: Colors.white)), // Burada yazı rengini beyaz olarak ayarladım.
        content: SingleChildScrollView(
          child: Column(
            children: [
              TextField(
                decoration: InputDecoration(labelText: 'Product Name', labelStyle: TextStyle(color: Colors.white)), // Burada yazı rengini beyaz olarak ayarladım.
                style: TextStyle(color: Colors.white), // Burada yazı rengini beyaz olarak ayarladım.
                onChanged: (value) {
                  productName = value;
                },
              ),
              TextField(
                decoration: InputDecoration(labelText: 'Product Artist', labelStyle: TextStyle(color: Colors.white)), // Burada yazı rengini beyaz olarak ayarladım.
                style: TextStyle(color: Colors.white), // Burada yazı rengini beyaz olarak ayarladım.
                onChanged: (value) {
                  productArtist = value;
                },
            ...
            onPressed: () {
              if (productName.isNotEmpty && productArtist.isNotEmpty) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                  content: Text('Please enter product name and artist.', style: TextStyle(color: Colors.white)), // Burada yazı rengini beyaz olarak ayarladım.
                ));
              }
            },
            child: Text('Add', style: TextStyle(color: Colors.white)), // Burada yazı rengini beyaz olarak ayarladım.
          ),
        ],
      ),
    );
  ...
  void _uploadProductToFirestore(String productName, String productArtist) async {
    await FirebaseFirestore.instance.collection('sculptureProduct').add({
  ...
  void _deleteProduct(String productId) {
    FirebaseFirestore.instance.collection('sculptureProduct').doc(productId).delete()
      .then((value) {
