...
class Drawings extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Drawings', style: TextStyle(color: Colors.black)),
      ),
      body: FutureBuilder(
        future: _getUserUid(), 
  ...
  Widget _buildProductList(String userUid) {
    return StreamBuilder(
      stream: FirebaseFirestore.instance.collection('drawingsProduct').orderBy('productName').snapshots(),
  ...
  void _uploadProductToFirestore(String productName, String productArtist) async {
    await FirebaseFirestore.instance.collection('drawingsProduct').add({
  ...
  void _deleteProduct(String productId) {
    FirebaseFirestore.instance.collection('drawingsProduct').doc(productId).delete()
      .then((value) {
